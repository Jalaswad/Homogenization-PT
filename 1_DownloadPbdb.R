#--------------------------------------------------------------------------------------
#Download data from pbdb from genus level:
#--------------------------------------------------------------------------------------
...
write.csv(data.pbdb, file="~/Desktop/PT/Codes/pbdb.aug2023.csv")
write.csv(gen1, file="~/Desktop/PT/Codes/gen1.csv")
#save(data.pbdb, file="~/Desktop/Stanford/Jood_Cosmo/pbdb.ma2022.csv")
#data.raw <- read.csv(file="/Users/geojood/Desktop/Stanford/Jood_Cosmo/pbdb.june2021.csv")
